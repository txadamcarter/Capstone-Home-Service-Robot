...
int main( int argc, char** argv )
{
  ...
  while (ros::ok())
  {
    ...
    marker.pose.orientation.x = -2.131610;
    marker.pose.orientation.y = -1.770400;
    ...
    marker.lifetime = ros::Duration(5.0);  // specify for how long this marker should stay before being deleted
    ROS_INFO("Publishing marker at initial position");
    ...
    ROS_INFO("Publishing marker at final position");
    marker_pub.publish(marker);
