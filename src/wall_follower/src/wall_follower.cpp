...
int main(int argc, char** argv)
{
    ...
    motor_command_publisher = n.advertise<geometry_msgs::Twist>("/navigation_velocity_smoother/raw_cmd_vel", 100);

    // Subscribe to the /scan topic and call the laser_callback function
    laser_subscriber = n.subscribe("/scan", 10, laser_callback);
